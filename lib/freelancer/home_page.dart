...
class __HomePageState extends State<_HomePage> {
  ...
  void initState() {
    super.initState();
    Provider.of<YourProviderClass>(context, listen: false)
        .fetchUserProfiles();
  }
                  ...
                  for (var i = startIdx; i < endIdx; i++)
                    if (i < provider.filteredProfiles.length)
                      Expanded(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            showProfileDialog(context, provider.filteredProfiles[i]);
                          },
                          child: Card(
                            color: const Color.fromARGB(255, 45, 45, 45),
                            elevation: 2,
                                ...
                                children: [
                                  Stack(
                                    children: <Widget>[
                                      CircleAvatar(
                                        backgroundImage: NetworkImage(
                                          provider.filteredProfiles[i].profileImageURL !=
                                              null
                                      ...
                                      if (provider.filteredProfiles[i].profileImageURL ==
                                          null)
                                        Container(
                                          width: 100,
                                          height: 100,
